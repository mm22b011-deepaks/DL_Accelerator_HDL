...
async def test_mac(dut):
    ...
    if dut.put_s1_or_s2_in.value == 1:
        ...
        for i in range(0,len(A_bin1)):
            ...
            dut_result = int(dut.get_result.value)
    ...
    if dut.put_s1_or_s2_in.value == 1:
        ...
        for i in range(8):
                ...
                en2 = int(dut.EN_get_result.value)
                ...
                for j in range(32):
                    ...
                    mac_out = model_mac(en2, value_a, value_b, value_c, value_s)
                    dut_result = int(dut.get_result.value)
